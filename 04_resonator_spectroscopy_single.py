...
frequencies = {
    "q1_rr": np.arange(-500e6, +500e6, 1000e3),
...
my_compiler_options = CompilerOptionArguments(flags=['enable-reset-all-phases-at-program-start'])
...
if __name__ == "__main__":
    ...
    if simulate:
        ...
        try:
            ...
            job = qm.execute(PROGRAM, compiler_options = my_compiler_options)
