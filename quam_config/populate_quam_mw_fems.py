...
with open(r"C:\Users\squirl\QM_New\CS_installations-HI_16Jun2025\workspaces\setup_info\250613_YD27Q_OPX1K.yaml") as stream:
    try:
...
grid_locations = [
    "0,8", "0,7",  "0,4", "0,3", "0,2", "0,1", "0,0",
    "1,8", "1,7", "1,6", "1,5",  "1,2", "1,1", "1,0",
